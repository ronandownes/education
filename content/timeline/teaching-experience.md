...
- **Mixed programmes and pathways:** experience includes Junior Cycle, Transition Year, Leaving Certificate Higher and Ordinary Level, Foundation Level and LCA.
- **Classroom structure:** examples available across different school settings for routines, low-level disruption, challenging behaviour and use of school systems.
