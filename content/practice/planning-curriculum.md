...
## TY curriculum — How would you design a TY Maths programme from scratch?

**Purpose → Audit → Design → Experience → Assess → Evaluate.** I would not begin with a textbook or a list of chapters. I would begin by asking what I want students to be able to **do mathematically by June that they could not do in September**, then audit the school context, student interests and prior learning. I would design within the **Transition Year Programme Statement**, using its emphasis on personal growth, being a learner, civic and community engagement and career development, but I would use the freedom of TY to make Mathematics feel genuinely different from third year or fifth year. I would build a small number of substantial modules around areas such as **mathematical modelling and data, financial mathematics, coding and AI, probability and risk, practical geometry and design, and a student-chosen investigation or community project**. Each module would culminate in something students have **made, analysed, solved, presented or defended**, rather than simply a chapter test. I would deliberately build in collaboration, communication, digital tools, careers and real-world links while still strengthening number sense, algebraic thinking, problem-solving and reasoning. Assessment would be mainly **formative and portfolio-based**, using clear success criteria, reflection, project products, presentations and peer/self-assessment. At the end of the year I would evaluate the programme using student work, student voice and engagement evidence, retain what produced genuine mathematical growth and redesign what did not. **TY Maths should be mathematically serious, but it should not feel like an extra year of exam preparation.**
